...
import type { SkinId } from '../../../components/games/FroggerGame';
import MobileGamepad from '../../../components/MobileGamepad';

const FroggerGame = dynamic(
  () => import('../../../components/games/FroggerGame'),
  { ssr: false }
);

const GAME_ID = 'frogger';
const SKIN_KEY = 'av_skin_frogger';
...
export default function FroggerPlayPage() {
  ...
  return (
    <div className="av-player fade-in">
      ...
      {/* CRT */}
      <div className="crt w-full h-auto max-w-[480px] mx-auto">
        <div className="crt-screen" style={{ aspectRatio: '0' }}>
          <FroggerGame
            key={gameKey}
            paused={paused}
            skin={skin}
